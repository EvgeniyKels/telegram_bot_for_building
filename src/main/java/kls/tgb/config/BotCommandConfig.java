...
import kls.tgb.telegram.userinputhandlers.commandhandlers.CommandAllExpensesHandler;
...
public class BotCommandConfig {
    ...
    public Map<String, CommandHandler> commandHandlerMap(
            ...
            CommandAllExpensesHandler commandAllExpensesHandler) {
...
//                Pair.of(commandReloadHandler.getHandlerName(), commandReloadHandler.getHandlerDescription()),
                ...
                Pair.of(commandAllExpensesHandler.getHandlerName(), commandAllExpensesHandler.getHandlerDescription())
                );
        botCommands(pairs);
